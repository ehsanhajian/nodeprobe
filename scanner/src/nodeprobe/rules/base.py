...
from nodeprobe.models import CheckKind, Confidence, Finding, ScanProfile, Severity
    ...
    def finding(
        ...
        *,
        ...
        return Finding(
            ...
            impact=self.meta.impact if impact is None else impact,
            remediation=self.meta.remediation if remediation is None else remediation,
